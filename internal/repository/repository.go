...
type EnrollmentRepository interface {
	...
	// StudentPlanRecords returns the records the eligibility rules evaluate a new
	// seat request against.
	StudentPlanRecords(ctx context.Context, studentID int64) ([]domain.Enrollment, error)
