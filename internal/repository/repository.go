...
type SessionRepository interface {
	...
	// RevokeSessionsForUser invalidates the live sessions of one principal and
	// reports how many rows it closed.
	RevokeSessionsForUser(ctx context.Context, userID int64, at time.Time) (int, error)
