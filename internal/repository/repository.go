...
type EnrollmentRepository interface {
	...
	// MeetingsForSections returns the weekly blocks of the given sections so a
	// caller that already knows which sections a student occupies does not need
	// a second scan over the enrollment table.
	MeetingsForSections(ctx context.Context, sectionIDs []int64) ([]domain.Meeting, error)
